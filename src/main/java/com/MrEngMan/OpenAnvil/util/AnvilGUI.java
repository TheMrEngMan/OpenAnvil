 ...
 *
 * Adapted for OpenAnvil by MrEngMan
 * 
**/

public class AnvilGUI {
	
	private Plugin plugin = OpenAnvil.getPlugin();
	
	private boolean colorrename = true;
	
	private Player player;
	private int originalPlayerLevel;
    private float originalPlayerExperience;
...
//                }
            ...
            public void ICE(InventoryCloseEvent e) {
                ...
                if(e.getInventory().equals(inventory)) {
                	player.setLevel(originalPlayerLevel);
                	player.setExp(originalPlayerExperience);
                    for(int i = 0; i < 2; i++) {
            ...
            public void PDE(PlayerDeathEvent e) {
                ...
                if(e.getEntity().equals(player)) {
                    ...
                    if(e.getDroppedExp() > 7 * originalPlayerLevel) {
                        e.setDroppedExp(7 * originalPlayerLevel);
                    }
                    HandlerList.unregisterAll(listener);
    ...
    public void open(String Title) {
        ...
        originalPlayerExperience = player.getExp();
